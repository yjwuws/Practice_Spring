...
public class TntDAO implements TenantDAO_interface {
	...
	// ================================= Register Form ==================================
	private static final String INSERT_RegisterForm_STMT = "INSERT INTO TENANT (TNT_NO, TNT_EMAIL, TNT_PWD, TNT_NAME, TNT_SEX)"
			+ "VALUES ('TNT' || lpad(SEQ_TNT_NO.NEXTVAL, 6, '0'),?,?,?,?)";
	private static final String UPDATE_RegisterForm_STMT = "UPDATE TENANT set TNT_EMAIL=?, TNT_PWD=?, TNT_NAME=?,  TNT_SEX=? where TNT_NO = ?";
	...
	public void insert(Registerform registerform) {
		...
		try {
			...
			pstmt = con.prepareStatement(INSERT_RegisterForm_STMT);
			
			con.setAutoCommit(false);

			pstmt.setString(1, registerform.getTnt_email());
			pstmt.setString(2, registerform.getTnt_pwd());
			pstmt.setString(3, registerform.getTnt_name());
			pstmt.setBoolean(4, registerform.getTnt_sex());
	...
	@Override
	public void update(Registerform registerform, String tnt_no) {
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(UPDATE_RegisterForm_STMT);
