...
public class TntVO implements java.io.Serializable {
	...
	@Column(name = "TNT_NO")  //@Column指這個屬性是對應到資料庫Table的哪一個欄位   //【非必要，但當欄位名稱與屬性名稱不同時則一定要用】
	@SequenceGenerator(name="name1", sequenceName="SEQ_TNT_NO", allocationSize=1) //1.先用@SequenceGenerator建立一個generator
