...
public class TntService {
	...
	public TenantDAO_interface getDao() {
		return dao;
	}

//	@Autowired
	public void setDao(TenantDAO_interface dao) {
		this.dao = dao;
	}
	...
	// Spring MVC 用
//	public void addTenant(Registerform registerform) {
//		dao.insert(registerform);
//	}

	public boolean addTenant(Registerform registerform) {
		int count = getAllAccount().stream()
				.filter(tntVO -> tntVO.getTnt_email().equals(registerform.getTnt_email()))
	...
	public void updateTenant(Registerform registerform, String tnt_no) {
		dao.update(registerform, tnt_no);
	}
...
//		tntVO.setTnt_no(tnt_no);
	...
	public TntVO updateTntBankCard(String tnt_no, String tnt_bank, String tnt_bankbranch, String tnt_bankacc,
			String tnt_card, String tnt_cardsvc, Date tnt_carddue) {
	...
	public TntVO updateTntVrf(String tnt_no, byte[] tnt_id_picf, byte[] tnt_id_picb, byte[] tnt_id_pic2,
			Timestamp tnt_id_uploadtime, int tnt_id_isupload, int tnt_id_result, String tnt_id_disapprove,
			Timestamp tnt_id_vrftime) {
	...
	public TntVO updateTntVrfPics(String tnt_no, byte[] tnt_id_picf, byte[] tnt_id_picb, byte[] tnt_id_pic2,
			int tnt_id_isupload) {
